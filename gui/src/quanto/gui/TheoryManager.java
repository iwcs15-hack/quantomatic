...
public class TheoryManager {
	...
	public void saveState() {
		...
		Preferences.userNodeForPackage(getClass()).put(lastTheoryKey, getId(theory));
		try {
	...
	private void loadFromStore() {
		if (!store.exists()) {
			...
			String lastActiveId = Preferences.userNodeForPackage(getClass()).get(lastTheoryKey, null);
